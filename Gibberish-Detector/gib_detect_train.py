...
def train():
    ...
    print "min(good_probs)=" + str(min(good_probs))
    print "max(bad_probs)=" + str(max(bad_probs))
    print "thresh=" + str(thresh)
    print avg_transition_prob("f_center", counts)
    print avg_transition_prob("e9ff8qgaxsxqybe6h", counts)
    print avg_transition_prob("HU9d3vGj1W", counts)
    print avg_transition_prob("aJxmnFbllPnwHslyMr", counts)
    print avg_transition_prob("text/javascript", counts)
