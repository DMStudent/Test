"""Asynchronous Adam for TensorFlow."""
...
class AsyncAdamOptimizer(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8,
               use_locking=False, name="AsyncAdam"):
    ...
    Args:
      ...
      name: Optional name for the operations created when applying gradients.
        Defaults to "Adam".
    """
    super(AsyncAdamOptimizer, self).__init__(use_locking, name)
