...
def parseArgs(args):
    ...
    parser.add_argument('--predit_output', type=str, default='./data/fake_outut.txt'
...
def main():
    ...
    with tf.Graph().as_default(), tf.Session(config=configproto) as sess:
        ...
        # fw2 = open("./data/result/0102/detail.txt", "w")
                ...
                for i in range(n_batches):
                    ...
                    for j in range(0, itemNum):
                        ...
                        if len(pair_tokens) > 2:
                            ...
                            # score_str1 = key + '\t' + pair_tokens[0] + '\t' + pair_tokens[1] + '\t' + str(
                            #     score[j][0]) + '\n'
